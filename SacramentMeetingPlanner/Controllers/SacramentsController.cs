...
namespace SacramentMeetingPlanner.Controllers
{
    public class SacramentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Conducting,HymnName,HymnNumber,Prayers,Speakers,Subjects,MeetingDate")] Sacrament sacrament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Conducting,HymnName,HymnNumber,Prayers,Speakers,Subjects,MeetingDate")] Sacrament sacrament)
        {
            if (id != sacrament.ID)
            {
                return NotFound();
